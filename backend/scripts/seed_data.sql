...
(1, 'user1@example.com', 'userone', 'hashed_password_1'),
(2, 'user2@example.com', 'usertwo', 'hashed_password_2');
...
INSERT INTO checklist_items (id, checklist_id, content, is_completed) VALUES
...
INSERT INTO card_history (id, card_id, user_id, change_type, changed_at) VALUES
(1, 1, 1, 'Card created', '2024-06-20 09:00:00'),
